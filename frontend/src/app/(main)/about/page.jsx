      ...
      <section className="bg-gray-100 py-16 px-6 md:px-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-12">
            {[
              { year: '2010', title: 'Founded', description: 'Started with a small team in Delhi with a mission to educate slum children.' },
              { year: '2015', title: 'First Milestone', description: 'Expanded to 3 cities, launched our first women empowerment program.' },
              { year: '2020', title: 'Global Impact', description: 'Touched over 150K lives and built strong partnerships internationally.' },
              { year: '2024', title: 'Digital Transformation', description: 'Launched e-learning and health tele-consultation platforms.' },
            ].map((item, i) => (
              <motion.div
                key={i}
      ...
      <section className="bg-white py-20 px-6 md:px-20">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { title: 'Education for All', description: 'Providing inclusive education to children and youth in remote and urban slums.', image: '/contact-hero.jpg' },
              { title: 'Clean Water Initiative', description: 'Delivering clean drinking water and sanitation to rural and drought-hit areas.', image: '/img2.png' },
              { title: 'Healthcare Access', description: 'Running mobile health clinics and health awareness drives in remote areas.', image: '/img3.png' },
              { title: 'Environmental Sustainability', description: 'Promoting green practices like tree planting and plastic-free campaigns.', image: '/img7.png' },
            ].map((program, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 30 }}
            ...
            {members.length > 0 ? members.map((member, i) => (
              ...
              >
                ...
                <div className="flex justify-center gap-4 text-blue-600 text-lg">
                  {member.linkedin && <a href={member.linkedin} target="_blank" rel="noreferrer"><FaLinkedinIn /></a>}
                  {member.twitter && <a href={member.twitter} target="_blank" rel="noreferrer"><FaTwitter /></a>}
                  {member.email && <a href={`mailto:${member.email}`}><FaEnvelope /></a>}
                </div>
              </motion.div>
            )) : <p className="text-gray-500 col-span-full">Loading team members...</p>}
          </div>
        </div>
      </section>
