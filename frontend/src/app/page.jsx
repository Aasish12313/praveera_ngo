      ...
      <div className="pt-24">
        ...
        <section className="relative py-20 bg-gradient-to-br from-green-100 via-white to-pink-100 text-center">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-lg text-gray-700 mb-8">
              Be part of the Praveera movement. Empower lives, build communities, and bring sustainable change.
            </p>
            <motion.button
              whileHover={{ scale: 1.05 }}
              className="bg-gradient-to-r from-pink-600 to-green-500 text-white px-10 py-4 rounded-full text-lg shadow-lg hover:shadow-xl transition"
            >
              Get Started
            </motion.button>
          </div>
