...
export const metadata = {
  title: "Praveers Foundation – Empowering Rural Futures",
  description:
    "Praveera Foundation is a community-led NGO focused on rural education, women empowerment, and environmental sustainability.",
};
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <head>
        {/* Include Razorpay script only if donation support is used */}
        <Script
